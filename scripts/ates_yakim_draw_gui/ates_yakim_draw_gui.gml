function ates_yakim_draw_gui(){
	if global.ates_yakim_basladi {
		...
		draw_set_alpha(0.7);
		var yazi_scale = 0.2;
		draw_text_transformed(goruntu_genislik / 2, (goruntu_yukseklik / 2) - 20, global.genel_yazilar[24], yazi_scale, yazi_scale, 0);
