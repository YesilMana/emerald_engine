...
function gelistirici() {
	if keyboard_check(vk_backspace) && true {
		...
		if keyboard_check(ord("G")) {
			npc_konum_kaydetme_ozel(obj_npc_helda, room, global.cikolata.x, global.cikolata.y, , , true);
			npc_konum_kaydetme_ozel(obj_npc_eymen, room, global.cikolata.x, global.cikolata.y, , , true);
			npc_konum_kaydetme_ozel(obj_npc_halil, room, global.cikolata.x, global.cikolata.y, , , true);
			npc_konum_kaydetme_ozel(obj_npc_ozan, room, global.cikolata.x, global.cikolata.y, , , true);
