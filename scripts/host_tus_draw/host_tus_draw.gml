				...
				if point_distance(mouse_x, mouse_y, x_cizim, y_cizim) < 15 {
					...
					if mouse_check_button_released(mb_left) {
						...
						if i == 12 {
							...
							if sonuc_numara == 549681 {
								ini_open("settings.ini");
								ini_write_real("ayarlar", "hikaye_tamamen_aktif_mi", 1);
								ini_close();
								game_restart();
							}
							
							if sonuc_numara == 125255 {
								odaya_isinlan(rm_belcinar_2_1_magara_1, 96, 150);
							}
							
							if sonuc_numara == 667787 {
								karart(3);
								global.hava_durumu = hava_enum.normal;
								odaya_isinlan(rm_premium_yapma, 614, 534);
							}
							
							
							if sonuc_numara == 555369 {
								demo_sonu_gecis();
							}
